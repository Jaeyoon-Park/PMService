...
<div id="fullpage">
    <div class="section wave_header cd-section" data-scroll-section id="section1">
        <!-- header -->
    ...
    <section class="section c-section cd-section" data-scroll-section id="section2">
        <div class="o-container">
            <div class="c-cta2">
    ...
    <section class="section c-section fixed-bg cd-section" data-scroll-section data-persistent id="section3">
    ...
    <section class="section c-section fixed-bg1" data-scroll-section data-persistent id="section3_2">
    ...
    <section class="section fixed-bg2 cd-section" data-scroll-section id="section4">
    ...
    <section class="section d-section cd-section fixed-bg3" data-scroll-section id="section5">
    ...
    <section class="section c-section cd-section fixed-bg4" data-scroll-section id="section6">
    ...
    <section class="section c-section cd-section" data-scroll-section id="section7">
